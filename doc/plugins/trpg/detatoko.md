...
基本ルールブックに掲載されている6系統の他、サプリメント『でたとこワールドツアー』で追加された2系統に対応しています。
...
サプリメント『でたとこダークネス』で追加された、「悪へのラスボス立場表」を振ります。

#### 例

```
.ddg
> でたとこサーガ [koi-chan]<悪へのラスボス立場>: [3,3:6] -> 6: 【有象無象】
。で敵へのラスボス立場
> でたとこサーガ [koi-chan]<悪へのラスボス立場>: [1,3:4] -> 4: 【悪の同輩】
```
...
クラスを選択します。
基本ルールブックに掲載された12種のほか、サプリメント『でたとこフロンティア』『でたとこダークネス』『でたとこワールドツアー』で追加された計10種のクラスを加えた全22種のクラスから1つをランダムに出力します。
...
サプリメント『でたとこダークネス』『でたとこワールドツアー』で追加されたものも出力されます。導入していない場合は振り直してください。
...
サプリメント『でたとこワールドツアー』で追加された、【好きなもの・趣味】／【苦手なもの・弱点】表から1つ選んで出力します。
d66 ダイスの結果に加え選択肢がもう1回ある項目についても、一つだけ出力するようになっています。

#### 例

```
.dlt
> でたとこサーガ [koi-chan]<趣味・弱点>: [1,3] -> 13 : 辛い食べ物
.dlt
> でたとこサーガ [koi-chan]<趣味・弱点>: [2,6] -> 26 : 倹約・貯金 (買い物・浪費／倹約・貯金)
.dlt
