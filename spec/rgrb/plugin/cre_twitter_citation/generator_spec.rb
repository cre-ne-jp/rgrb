...
describe RGRB::Plugin::CreTwitterCitation::Generator do
  ...
  describe '#tweet_to_message (private)' do
    ...
    context 'URL 入りのツイート' do
      ...
      let(:expected_message) do
        '【お知らせ】一部サイトのメンテナンスについて、告知です。9月1日の夜、個人ブログやIRCログ公開などへのアクセスが一時的にできなくなります。 http://wp.me/p4t2iA-47 (2014-08-29 22:21:49; https://twitter.com/cre_ne_jp/status/505344572990316545)'
      end
    ...
    context 'HTML 実体参照入りのツイート' do
      ...
      let(:expected_message) do
        '【お知らせ】#あけましておめでとうございます 、2015年もクリエイターズネットワークをよろしくお願いいたします！　また、今年も新年あけおめ掲示板を開設しました。皆様の書き込みをお待ちしております。 <(_ _)> http://wp.me/p4t2iA-ae (2015-01-01 00:47:32; https://twitter.com/cre_ne_jp/status/550317340177338368)'
      end
